...
;
-- Retriev the number of titles from the unique_titles table. -- ANSWER: 7 
SELECT COUNT(DISTINCT title) AS ut FROM unique_titles
;
-- Create Retiring Titles table to hold the required info 
